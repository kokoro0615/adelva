...
// 2026-08-30T11:06:00.898Z
//
//   import { transitions, variants } from './white-desert.com-motion.framer';
...
export const transitions = {
  base:  { duration: 1, ease: easings.easeIn },
  fast:  { duration: 0.500, ease: easings.easeIn },
  slow:  { duration: 1.800, ease: easings.easeIn },
  spring: springs.soft,
};
...
export const variants = {
  ...
  stagger: {
    hidden: {},
    show:   { transition: { staggerChildren: 0.200 } }, // observed at runtime
  },
  revealTransform: {
    hidden: {},
    show: {
