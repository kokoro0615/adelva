# You are building UI in the white-desert.com design system.

Source: https://white-desert.com/
Extracted by designlang on 2026-08-30.

## Brand at a glance

- title         Luxury Adventures in Antarctica | White Desert
- page intent   landing
- material      flat
- design grade  B
...
- secondary   #1f2a44
- accent      #ff7e15
- neutrals    #ffffff · #000000 · #535353 · #090b10 · #e9e7e1 · #c0c0c0

## Typography

- families   Inter Tight · Arial · Times New Roman · Cardinal Classic Long
- weights    400 · 500 · 600
- base size  16px

## Spacing

- scale      4px · 21px · 24px · 36px · 39px · 53px · 58px · 71px · 89px · 111px · 124px · 142px

## Radii

- scale      2px · 5px · 50px · 100px

## Motion

- durations  300ms · 450ms · 1000ms
...
- pronoun    you-only
- headings   Title Case
- CTA verbs  enquire · watch · south · get · how · experience
...
```bash
npx designlang white-desert.com
```
...
Generated by designlang. Re-extract by running `npx designlang white-desert.com`.
